// Ported verbatim from client/src/features/rank-predictor/collegeMeta.js.
//
// Used by CollegeCard.tsx via getCollegeMeta(collegeName). The cards are fed
...
function fallback(name: string): CollegeMeta {
  return {
    name: name || "College",
    shortName: name || "",
    logo: "",
 ...
 */
export function getCollegeMeta(collegeName?: string | null): CollegeMeta {
