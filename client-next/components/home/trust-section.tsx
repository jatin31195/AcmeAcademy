...
import { Users, Target, BookOpen, PlayCircle, type LucideIcon } from "lucide-react";

// Ported from client/src/components/home/TrustSection.jsx. Counter uses
// setInterval (must be Client).
const statsData: { icon: LucideIcon; value: number; suffix: string; label: string }[] = [
