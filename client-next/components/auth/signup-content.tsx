...
import OtpInput from "@/components/auth/otp-input-dynamic";
...
export function SignupContent() {
  ...
  const onRegister = async (verifiedToken: string = otpToken) => {
    setLoading(true);
    try {
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 px-4 text-center text-white">
        <div className="flex max-w-sm flex-col items-center space-y-4 rounded-2xl border border-white/10 bg-white/10 px-5 py-6 shadow-[0_20px_60px_rgba(0,0,0,0.25)] backdrop-blur-xl">
          <Image src="/logo.png" alt="ACME Academy Logo" width={842} height={711} className="h-14 w-14 rounded-2xl shadow-lg animate-bounce" />
          <h1 className="text-2xl font-bold leading-tight sm:text-3xl">Account Created Successfully!</h1>
          <p className="text-sm leading-relaxed text-blue-100 sm:text-base">
            Welcome to <span className="font-semibold text-white">ACME Academy</span> — your journey to MCA excellence begins here. Redirecting to
            login...
          </p>
      ...
      <div className="relative w-full max-w-sm sm:max-w-md">
        <div className="rounded-3xl border border-white/10 bg-white/8 p-4 shadow-[0_28px_80px_rgba(0,0,0,0.5)] backdrop-blur-2xl sm:p-5">
          <div className="mb-3 flex justify-center">
            <Image src="/logo.png" alt="ACME Academy" width={842} height={711} className="h-12 w-auto drop-shadow-[0_8px_24px_rgba(0,0,0,0.35)] sm:h-14" />
          </div>

          {!showOTP ? (
            <>
              <h2 className="mb-3 text-center text-xl font-bold leading-tight text-white sm:text-2xl">Register Account</h2>
              <p className="mb-4 text-center text-[12px] leading-snug text-gray-300 sm:text-sm">
                ...
                <span className="text-yellow-200">This email and password will be used for future login.</span>
              </p>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="mt-2 text-center">
                  <p className="text-xs text-gray-400 sm:text-sm">
                    ...
                    <span onClick={() => router.push("/login")} className="cursor-pointer text-emerald-500 hover:underline">
                      Login
                    </span>
                  </p>
                </div>
            ...
            <>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5 shadow-inner shadow-black/10">
                <div className="mb-4 text-center">
                  ...
                  <h2 className="mt-3 text-xl font-bold leading-tight text-white sm:text-2xl">Enter OTP</h2>
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <button onClick={sendOtp} className="text-sm font-medium text-cyan-300 transition hover:text-cyan-200 hover:underline">
                    Resend OTP
                  </button>
                </div>
              </div>
