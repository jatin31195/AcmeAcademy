...
// Ported verbatim from client/src/components/ExamPattern/Nimcet2025.jsx.
// Mounted both as one ExamPattern tab AND as its own standalone route
// (/exams-pattern/nimcet-2025) in the original App.jsx — same component
// reused both ways here too.
const Nimcet2025 = () => {
    ...
    <div className="space-y-10">
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
        <TabsList className="flex flex-wrap justify-center bg-gray-50 border p-2 rounded-2xl shadow-sm">
          <TabsTrigger
            value="overview"
            className="px-4 py-2 font-semibold data-[state=active]:text-white data-[state=active]:bg-gradient-to-r data-[state=active]:from-indigo-500 data-[state=active]:to-pink-500 rounded-xl transition-all"
          >
            Overview
          </TabsTrigger>
          <TabsTrigger
            ...
            <Card className="bg-white/90 backdrop-blur-xl border border-gray-100 rounded-3xl p-6 shadow-lg">
              ...
              <CardContent>
                <ul className="list-disc pl-6 text-sm text-gray-700 space-y-1">
                  ...
                  <li>
                    <b>Tie-breakers:</b> Maths → Reasoning → Computer → Age → Random
                  </li>
                </ul>
              </CardContent>
            </Card>
