...
// Ported verbatim from client/src/components/ExamPattern/Cuetpg.jsx.
// Client Component: useState tab state + Radix Tabs (no framer-motion here,
// unlike its 4 sibling exam-pattern components).
const Cuetpg = () => {
            ...
            <Card className="glass border shadow-lg">
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                {Object.entries(overview).map(([key, value], index) => (
                  <div
                    key={index}
                    className="p-4 border rounded-lg hover:shadow-md transition-all duration-200 hover:bg-white"
                  >
