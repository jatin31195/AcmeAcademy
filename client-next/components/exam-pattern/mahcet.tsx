...
// Ported verbatim from client/src/components/ExamPattern/Mahcet.jsx.
const Mahcet = () => {
  ...
  const institutes = [
    {
      name: "Government & Private Institutes in Maharashtra",
      contact: "Admissions via CET Cell Maharashtra",
