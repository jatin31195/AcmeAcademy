...
// Ported verbatim from client/src/components/ExamPattern/Jmi.jsx
// (default-exported as `JMI` there; kept the same internal name).
const JMI = () => {
  const [selectedTab, setSelectedTab] = useState("overview");

  const parts = [
    { part: "Section-I", subject: "Mathematics", questions: "40% (Approx.)", marks: "Major Weightage" },
    { part: "Section-II", subject: "Computer Fundamentals & Awareness", questions: "40% (Approx.)", marks: "Major Weightage" },
    { part: "Section-III", subject: "Reasoning", questions: "10% (Approx.)", marks: "Moderate" },
    { part: "Section-IV", subject: "General English", questions: "10% (Approx.)", marks: "Moderate" },
  ];
            ...
            <Card className="bg-white/90 backdrop-blur-xl shadow-lg border border-gray-100 p-4 sm:p-6 rounded-3xl">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  ...
                  <br />
                  • Distribution: 40% Maths, 40% Computer, 10% Reasoning, 10% English.
                  <br />
                  • Duration: 2 hours.
                  <br />
