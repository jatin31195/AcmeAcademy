...
import { Users, Award, BookOpen, Target, Heart, Lightbulb, type LucideIcon } from "lucide-react";
...
// Ported from client/src/pages/About.jsx. Nearly every section in this page
// uses framer-motion for entrance animation, so — per the migration
// blueprint's own guidance that full-Client is the correct call when motion
// usage is this pervasive (rather than dozens of tiny Motion Wrapper
// boundaries) — the entire visual body lives in this single Client
// Component. The page-level generateMetadata/JSON-LD (the SEO-critical
// part) stays in the Server page.tsx wrapper.

const achievements: { icon: LucideIcon; label: string; value: string }[] = [
...
const values: { icon: LucideIcon; title: string; description: string }[] = [
  {
    icon: Lightbulb,
    title: "Vision",
    description: "To create highly competent MCA professionals by imparting quality education and confidence.",
  },
  {
    icon: Heart,
    title: "Care",
    description: "Every student is important. We provide personalized attention and care.",
  },
  {
    icon: Target,
    title: "Mission",
    description: "To transform average students into achievers with real exam-level guidance.",
  },
];
...
const milestones = [
  ...
  },
  {
    ...
    description: "Learners from every corner of India joined ACME's programs, making it a leading national name in MCA preparation.",
  },
  {
    year: "2023",
    title: "Expansion to Lucknow",
    highlight: "Offline Growth",
    description: "With growing demand, ACME opened its new offline center in Lucknow, bringing top mentorship to North India.",
  },
  {
    year: "2025",
  ...
  },
  {
    ...
    description: "With 2000+ selections in NITs, DU, JNU, BHU, JMI & HCU — ACME continues to build NITians with trust, quality, and results.",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 60 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4">
              ...
              <strong>Dr. Kartikey Pandey</strong> — a PhD (Mathematics) from <strong>NIT Raipur</strong> — has been at the
              forefront of <strong>MCA Entrance Exam</strong> preparation in India.
            </p>

            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4">
              Known for his vision, discipline, and mentoring excellence, he&apos;s not just the <strong>Director</strong> of the
              institution but the <strong>soul</strong> of ACME Academy. His leadership inspires innovation, hard work, and
              success — creating a legacy of over <strong>2000+ selections</strong> in premier institutions like
              <strong> NITs, DU, JNU, BHU, JMI, HCU</strong> and more.
            </p>

            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-6">
              His philosophy, <em>&quot;We deliver what we promise,&quot;</em> drives every aspect of ACME&apos;s journey. Through
              up-to-date study materials, rigorous guidance, and personalized mentorship, he ensures every student achieves their
              highest potential.
            </p>

            <div className="flex flex-wrap gap-4 mt-6">
              <Link href="/acme-academy-results">
              ...
              <Button variant="outline" className="border-gray-400 text-gray-700 hover:text-purple-600 hover:border-purple-400">
                Meet Our Faculty
              </Button>
            </div>
          </motion.div>
      ...
      <section className="relative py-20 bg-gradient-to-b from-purple-50 via-gray-50 to-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-semibold mb-3 text-purple-700 font-[Poppins]">Our Vision</h3>
              <p className="text-gray-700 leading-relaxed text-base md:text-lg font-[Inter] tracking-wide">
                ACME Academy strives to be a pioneer of excellence in MCA Entrance coaching, nurturing disciplined, confident,
                and skilled aspirants ready to lead the technology-driven world.
              </p>
            ...
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-xl border border-gray-200 px-10 py-8
                   ...
                   md:min-h-[280px] flex flex-col justify-center"
            >
              <h3 className="text-2xl md:text-3xl font-semibold mb-3 text-pink-700 font-[Poppins]">Our Mission</h3>
              <p className="text-gray-700 leading-relaxed text-base md:text-lg font-[Inter] tracking-wide">
                To deliver <strong>100% success</strong> through real exam-level preparation, modern teaching strategies, and
                personal mentorship that transform every student into an achiever.
              </p>
              <p className="text-gray-700 leading-relaxed text-base md:text-lg mt-3 font-[Inter] tracking-wide">
                Guided by the principle <em>&quot;Practice and Patience Make a Man Perfect,&quot;</em> we cultivate excellence
                through structured learning and continuous improvement.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
            {values.map((v, i) => (
              ...
              >
                ...
                <h3 className="mt-10 text-xl sm:text-2xl font-bold text-gray-800 mb-3">{v.title}</h3>
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">{v.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-20 bg-gradient-to-b from-white via-purple-50 to-pink-50 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <div className="space-y-12">
              {milestones.map((m, i) => (
                <motion.div
                  ...
                  className={`relative flex items-center ${i % 2 === 0 ? "justify-start" : "justify-end"} sm:gap-10`}
                >
                  ...
                  >
                    <Badge variant="outline" className="border-purple-300 text-purple-700 mb-2 font-medium text-xs px-3 py-1">
                      {m.year}
                    </Badge>
                    ...
                    <p className="text-sm text-purple-700 font-medium mb-1 italic">{m.highlight}</p>
                    <p className="text-gray-600 leading-relaxed text-sm">{m.description}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          >
            💫 <span className="font-semibold text-purple-700">ACME ACADEMY</span> — Transforming Aspirations into Achievements
            since <span className="text-pink-600 font-bold">2015</span>
          </motion.div>
        </div>
      </section>
                ...
                <div className="relative w-24 h-24 mx-auto mb-5">
                  <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-purple-500 to-pink-500 p-1">
                    <div className="w-full h-full rounded-full bg-white overflow-hidden">
                      <Image src={f.image} alt={f.name} className="w-full h-full object-cover rounded-full" />
                    </div>
                  </div>
                </div>

                <h3 className="text-lg sm:text-xl font-bold text-gray-800">{f.name}</h3>
                <p className="text-purple-600 text-sm font-semibold">{f.designation}</p>
                <p className="text-gray-500 text-xs sm:text-sm mt-1">{f.qualification}</p>
                {f.experience && (
                  <Badge variant="secondary" className="mt-2 mb-1 bg-purple-100 text-purple-700 border border-purple-300">
                    {f.experience}
                  </Badge>
                )}
                <p className="text-gray-600 text-xs sm:text-sm mt-1 italic">{f.specialization}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-8 text-sm sm:text-base leading-relaxed">
              Become a part of <span className="font-semibold text-purple-600">ACME Academy&apos;s</span> legacy of excellence
              and achieve your MCA dreams with expert mentors guiding every step.
            </p>
