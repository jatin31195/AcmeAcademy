...
// component at all — a gap identified during the migration audit — so this
// generateMetadata export is new, not a port, per the approved gap-fix
// (blueprint SEO Plan: legal pages should get at least basic canonical
// metadata even though they never had it before).
export const metadata: Metadata = {
  title: "Privacy Policy | ACME Academy",
  description:
    "Read ACME Academy's Privacy Policy to understand how we collect, use, store, and protect your personal information.",
  alternates: {
    canonical: "/privacy",
  },
  openGraph: {
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100">
      <section className="relative overflow-hidden py-14 sm:py-16 border-b border-slate-200">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="mt-3 text-3xl sm:text-4xl font-extrabold text-slate-900">Privacy Policy</h1>
