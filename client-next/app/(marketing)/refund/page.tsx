...
// over unchanged since this is legal-text content, not something to silently
// "fix" during a parity migration. generateMetadata is new (gap-fix, same
// rationale as the other legal pages).
export const metadata: Metadata = {
  title: "Refund and Cancellation Policy | ACME Academy",
  description:
    "Read ACME Academy's Refund and Cancellation Policy covering fee payments, cancellations, and refund eligibility.",
  alternates: {
    canonical: "/refund",
  },
  openGraph: {
