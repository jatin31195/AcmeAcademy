...
const categoryBadgeClass = {
  counselling: "bg-emerald-500/15 border-emerald-500/40 text-emerald-700 dark:text-emerald-300",
  course: "bg-cyan-500/15 border-cyan-500/40 text-cyan-700 dark:text-cyan-300",
  admission: "bg-violet-500/15 border-violet-500/40 text-violet-700 dark:text-violet-300",
  feedback: "bg-amber-500/15 border-amber-500/40 text-amber-700 dark:text-amber-300",
  suggestion: "bg-blue-500/15 border-blue-500/40 text-blue-700 dark:text-blue-300",
  other: "bg-slate-500/15 border-slate-500/40 text-slate-700 dark:text-slate-300",
};
        ...
        {filtered.map((e) => (
          <div key={e.id} className="rounded-xl border border-border bg-card p-4 shadow-sm">
            ...
            <Button
              variant="outline"
              size="sm"
              className="mt-3 h-9 w-full border-rose-500/40 text-rose-600 dark:text-rose-400 hover:bg-rose-500/10"
