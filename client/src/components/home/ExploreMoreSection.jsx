...
import { Dumbbell, Library, FileText, Compass, ListChecks } from "lucide-react";

// Pure internal-linking hub — no API calls, no backend dependency. Fills the gap
// where Practice Sets, Open Library, PYQ, and Rank Predictor previously had no
// path in from the homepage at all (every link below is an existing route).
const links = [
  {
